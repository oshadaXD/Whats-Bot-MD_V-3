...
const ThanksTo = require("./components/Thanks_to");
...
const { D_E_TMB, SEND_REED, D_E_DPC, myweb, sc } = require("./lib/config");
...
const icons =
  "🚗🛺🚌🚎🚒🚜🛴🚄🚠🚦⚓🛰🌍🌝🌚🌞❄☂🔥💧☃❤🧡💛💚💙💜🤎🖤💖💗💓💞💕❣💔🤍💘💝💟💠🔸🔹";
const icon = icons[Math.floor(43 * Math.random())];
  ...
  try {
        ...
        m.chat,
        {
          ...
          contextInfo: {
            externalAdReply: {
              ...
              previewType: "PHOTO",
              thumbnailUrl: ``,
              thumbnail: fs.readFileSync(`./Media/gojo.jpg`),
              sourceUrl: D_E_TMB,
            },
          },
        },
    ...
    if (db.data.settings[botNumber].autobio) {
      ...
      if (new Date() * 1 - setting.status > 1000) {
        ...
        await conn.setStatus(
          `${conn.user.name} | Runtime : ${runtime(uptime)}`
        );
    ...
    if (db.data.chats[m.chat].antilink) {
      if (budy.match(`chat.whatsapp.com`)) {
        ...
        if (!isBotAdmins)
          return reply(
            `I Am Not An Admin, How Could I Kick Somebody Who Send Link 😒`
          );
        let gclink =
        ...
        if (isgclink)
          return reply(
            `Group Is Installed With Anti-Link But I Won't Kick You 😉, Because You Sent This Group Link❤️`
          );
        if (isAdmins)
          return reply(
            `Group Is Installed With Anti-Link But I Won't Kick You 😉, Because You Are An Admin Of The Group❤️`
          );
        if (isCreator)
          return reply(
            `Group Is Installed With Anti-Link But I Won't Kick You 😉, Because You Are My Owner Hahahahah🤣😘, You Think I Will Betray You Huh🐦`
          );
          ...
          [
            {
              ...
              buttonText: { displayText: "Guess The Blank" },
              type: 1,
            },
          ],
          `🎮 Guess The Blank 🎮\n\nCorrect Answer 🎉\n*${deskripsi}*\n\nWant To Play Again? Press The Button Below`,
          ...
          [
            {
              ...
              buttonText: { displayText: "Guess The Riddle" },
              type: 1,
            },
          ],
          `🎮 Guess The Riddle 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`,
...
Typed *surrender* to surrender and admited defeat`;
      ...
      if (room.x !== room.o)
        await conn.sendText(room.x, str, m, { mentions: parseMention(str) });
    ...
    if (roof) {
      ...
      if (
        m.sender == roof.p2 &&
        /^(acc(ept)?|accept|yes|okay?|reject|no|later|nope(k.)?yes|y)/i.test(
          m.text
        ) &&
        m.isGroup &&
        roof.status == "wait"
      ...
      case "mine":
        {
          ...
          if (isCekDarah < 1)
            return reply(`You're Tired!, Try To Heal Using Potions`);
      ...
      case "buy":
        {
          ...
          if (args[0] === "potion") {
            ...
            if (isMonay < noh)
              return reply(
                "Your Remaining Money Is Not Sufficient For This Purchase"
              );
            ...
            if (!args[1])
              return reply(
                `Example : ${prefix + _command} limit 2\n 1 Limit = 35000 Money`
              );
            if (isMonay < noh)
              return reply(
                "Your Remaining Money Is Not Sufficient For This Purchase"
      ...
      case "jual":
        {
          ...
          if (args[0] === "fish") {
            if (isIkan < anu)
              return reply(
                `You Don't Have Enough Fish(es) For This Transaction`
              );
            if (!args[1])
              return reply(
                `Example : ${prefix + _command} fish 2\n 1 Fish = 1500 Money`
              );
            ...
            if (isAyam < anu)
              return reply(
                `You Don't Have Enough Chicken(s) For This Transaction`
              );
            if (!args[1])
              return reply(
                `Example : ${
            ...
            if (isKelinci < anu)
              return reply(
                `You Don't Have Enough Rabbit(s) For This Transaction`
              );
            if (!args[1])
              return reply(
                `Example : ${
            ...
            if (isDomba < anu)
              return reply(
                `You Don't Have Enough Sheep(s) For This Transaction`
              );
            if (!args[1])
              return reply(
                `Example : ${prefix + _command} domba 2\n 1 Sheep = 5000 money`
              );
            ...
            if (isSapi < anu)
              return reply(`You Don't Have Enough Cow(s) For This Transaction`);
            if (!args[1])
              return reply(
                `Example : ${prefix + _command} cow 2\n 1 Cow = 10000 Money`
              );
            ...
            if (isGajah < anu)
              return reply(
                `You Don't Have Enough Elephant(s) For This Transaction`
              );
            if (!args[1])
              return reply(
                `Example : ${
            ...
            if (isBesi < anu)
              return reply(
                `You Don't Have Enough Iron(s) For This Transaction`
              );
            if (!args[1])
              return reply(
                `Example : ${prefix + _command} iron 2\n 1 Iron = 15000 Money`
              );
            ...
            if (isEmas < anu)
              return reply(
                `You Don't Have Enough Gold(s) For This Transaction`
              );
            if (!args[1])
              return reply(
                `Example : ${prefix + _command} gold 2\n 1 Gold = 50000 Money`
              );
            ...
            if (isEmerald < anu)
              return reply(
                `You Don't Have Enough Emerald(s) For This Transaction`
              );
            if (!args[1])
              return reply(
                `Example : ${
            ...
            setTimeout(() => {
              reply(
                `Transaction Successful ✔️\n*Your Remaining Money* : ${getMonay(
                  m.sender
                )}\n*You Don't Have Enough Emerald(s) For This Transaction* : ${getEmerald(
                  m.sender
                )}`
              );
            }, 2000);
      ...
      case "heal":
        {
          if (q.includes("--help")) return reply(examkosong);
          if (!isCekDarah < 1)
            return reply("You Can Only Heal When Your Blood Is 0");
          if (isCekDarah > 100) return reply("Your Blood Is Full");
          if (isPotion < 1)
            return reply(
              `You Don't Have A Potion, Try Buying It This Way #buypotion _amount_`
            );
      ...
      case "hunting":
        {
          ...
          if (isCekDarah < 1)
            return reply("Your Blood Is Gone, Try To Heal Using Potions");
          if (!isInventoriBuruan) {
            addInventoriBuruan(m.sender);
          }
          let luka = [
      ...
      case "tictactoe":
        {
          ...
          if (
            ...
            return replay(`You Are Still In The Game`);
          let room = Object.values(this.game).find(
            (room) =>
...
Type *surrender* to surrender and admit defeat`;
            ...
            reply(
              "Waiting For Partner" +
                (text
                  ? ` Type The Command Below ${prefix}${_command} ${text}`
                  : "")
            );
      ...
      case "suit":
        {
          ...
          if (
            ...
            return replay(`Complete Your Previous Suit`);
          if (m.mentionedJid[0] === m.sender)
            return reply(`Can't Play With Myself !`);
          if (!m.mentionedJid[0])
            return reply(
...
Please @${m.mentionedJid[0].split`@`[0]} To Type Accept/Reject`;
          this.suit[id] = {
            ...
            status: "wait",
            waktu: setTimeout(() => {
              if (this.suit[id]) conn.sendText(m.chat, `_Suit Time Out_`, m);
              delete this.suit[id];
            }, 60000),
            poin,
            poin_lose,
      ...
      case "family100":
        {
          ...
          let hasil = `*Answer The Following Questions :*\n${
            random.soal
          }\n\nThere Is *${random.jawaban.length}* Answer ${
      ...
      case "holoh":
        if (!m.quoted && !text)
          return replay(`Send/Reply Text With Caption ${prefix + _command}`);
        ter = _command[1].toLowerCase();
        tex = m.quoted
          ? m.quoted.text
            ? m.quoted.text
            : q
      ...
      case "guess":
        {
          ...
          if (args[0] === "song") {
            if (tebaklagu.hasOwnProperty(m.sender.split("@")[0]))
              return replay(`There Are Still Unfinished Sessions`);
            let anu = await fetchJson(
            ...
            if (tebaklagu.hasOwnProperty(m.sender.split("@")[0])) {
              ...
              conn.sendButtonText(
                ...
                `Time Has Run Out\nAnswer:  ${
                  tebaklagu[m.sender.split("@")[0]]
                }\n\nWant To Play? Press The Button Below`,
                conn.user.name,
                m
              );
              delete tebaklagu[m.sender.split("@")[0]];
            ...
            if (tebakgambar.hasOwnProperty(m.sender.split("@")[0])) {
              ...
              conn.sendButtonText(
                ...
                `Time Has Run Out\nAnswer:  ${
                  tebakgambar[m.sender.split("@")[0]]
                }\n\nWant To Play Again? PressThe Button Below`,
                conn.user.name,
                m
              );
              delete tebakgambar[m.sender.split("@")[0]];
            ...
            if (tebakkata.hasOwnProperty(m.sender.split("@")[0]))
              return replay(`There Are Still Unfinished Sessions!`);
            let anu = await fetchJson(
              "https://raw.githubusercontent.com/nexusnw/fungames/main/GuessTheWord.js"
            );
            let result = anu[Math.floor(Math.random() * anu.length)];
            conn
              .sendText(
            ...
            if (tebakkalimat.hasOwnProperty(m.sender.split("@")[0]))
              return replay(`There Are Still Unfinished Sessions!`);
            let anu = await fetchJson(
              "https://raw.githubusercontent.com/nexusnw/fungames/main/GuessTheSentence.js"
            );
            let result = anu[Math.floor(Math.random() * anu.length)];
            conn
              .sendText(
            ...
            conn
              .sendText(
                m.chat,
                `These Are The Lyrics Of Which Song? : *${result.soal}*?\nTime : 60 seconds`,
                m
              )
              .then(() => {
...
@${me.split("@")[0]} ❤️ @${jodoh.split("@")[0]}`;
          ...
          await conn.sendButtonText(m.chat, buttons, jawab, conn.user.name, m, {
            mentions: ments,
          });
        }
        break;
...
Cieeee, What's Going On❤️💖👀`;
      ...
      case "is":
        if (!text)
          return replay(`Use Text, Example : ${prefix + _command} he married `);
      ...
      case "can":
        if (!text)
          return replay(
            `Use Text, Example : ${prefix + _command} you fuck her lol `
          );
      ...
      case "how":
        if (!text)
          return replay(`Use Text, Example : ${prefix + _command} is my face`);
        const gimana = [
          `It's Okay`,
          `It's Difficult Bro`,
      ...
      case "rate":
        if (!text)
          return replay(`Use Text, Example : ${prefix + _command} My Dp`);
        const ra = [
          "1",
          "2",
          "3",
      ...
      case "handsomecheck":
        if (!text)
          return replay(`Tag Someone, Example : ${prefix + _command} @Xeon`);
        const gan = [
          "1",
          "2",
          "3",
      ...
      case "hot":
        {
          ...
          let me = m.sender;
          let jodoh = member[Math.floor(Math.random() * member.length)];
          let jawab = `The Most *${_command}* Here Is @${jodoh.split("@")[0]}`;
          let ments = [me, jodoh];
          let buttons = [
      ...
      case "when":
        if (!text)
          return replay(
            `Use Text, Example : ${prefix + _command} will i get married `
          );
        const kapan = [
          "5 More Days",
          "10 More Days",
      ...
      case "wangy":
        if (!text)
          return replay(`Use Text, Example : ${prefix + _command} hinata`);
        qq = q.toUpperCase();
      ...
      case "checkdeath":
        if (!text)
          return replay(
            `Use Someone's Name, Example : ${prefix + _command} nexus`
          );
        predea = await axios.get(`https://api.agify.io/?name=${q}`);
        reply(
          `Name : ${predea.data.name}\n*Dead At Age :* ${predea.data.age} Year.\n\n_Quick, Quick, Repent Bro, Because No One Knows About Death_`
        );
        break;
      case "halah":
      case "hilih":
      ...
      case "setexif":
        {
          if (!isCreator) return replay(`${mess.owner}`);
          if (!text)
            return replay(`Example : ${prefix + _command} packname|author`);
      ...
      case "setbotpp":
        {
          if (!isCreator) return replay(`${mess.owner}`);
          if (!quoted)
            return replay(`Send/Reply Image With Caption ${prefix + _command}`);
          if (!/image/.test(mime))
            return replay(`Send/Reply Image With Caption ${prefix + _command}`);
          if (/webp/.test(mime))
            return replay(`Send/Reply Image With Caption ${prefix + _command}`);
      ...
      case "styletext":
        {
          if (!isPremium && global.db.data.users[m.sender].limit < 1)
            return reply(mess.endLimit); //wont response when limit runs out\\
          ...
          let buttonsVote = [
            {
              ...
              buttonText: { displayText: "Upvote" },
              type: 1,
            },
            {
              buttonId: `${prefix}devote`,
              buttonText: { displayText: "Devote" },
              type: 1,
            },
          ];
...
`;
      ...
      case "bcgroup":
        {
          ...
          reply(
            `Sent Broadcast To ${anu.length} Group Chat, Finish Time ${
              anu.length * 1.5
            } Seconds`
          );
          for (let i of anu) {
      ...
      case "infochat":
        {
          ...
          if (!m.quoted.isBaileys)
            return replay(`The Message Was Not Sent By A Bot!`);
          let teks = "";
          for (let i of msg.userReceipt) {
            ...
            teks += ` ┗━🐦 *Time :* ${moment(waktu * 1000).format(
              "DD/MM/YY HH:mm:ss"
      ...
      case "sgif":
        {
          if (!quoted)
            return replay(
              `Reply Video/Image With Caption ${prefix + _command}`
            );
          reply(mess.wait);
          if (/image/.test(mime)) {
      ...
      case "stickmemex":
        {
          ...
          if (!text)
            return reply(
              `Send/Reply Photo With Caption ${prefix + _command} *Text*`
            );
          if (text.includes("|"))
            return reply(
              `Send/Reply Photo With Caption ${prefix + _command} *Text*`
      ...
      case "ebinary":
        {
          if (!m.quoted.text && !text)
            return replay(`Reply Text With Caption ${prefix + _command}`);
      ...
      case "emojimix":
        {
          if (!text) return replay(`Example : ${prefix + _command} 😅+🤔`);
      ...
      case "toimg":
        {
          ...
          if (!/webp/.test(mime))
            reply(`Reply Sticker With Caption *${prefix + _command}*`);
          reply(mess.wait);
          let media = await conn.downloadAndSaveMediaMessage(quoted);
      ...
      case "tovideo":
        {
          ...
          if (!/webp/.test(mime))
            return replay(`Reply Sticker With Caption *${prefix + _command}*`);
          reply(mess.wait);
      ...
      case "toaudio":
        {
          ...
          if (!quoted)
            return reply(
              `Send/Reply Video/Audio You Want To Convert To Audio With Caption ${
                prefix + _command
              }`
            );
          reply(mess.wait);
      ...
      case "tomp3":
        {
          ...
          conn.sendMessage(
            m.chat,
            {
              document: audio,
              mimetype: "audio/mpeg",
              fileName: `Converted By ${conn.user.name}.mp3`,
            },
            { quoted: m }
          );
        }
      ...
      case "togif":
        {
          if (!quoted) return reply(`Reply Image`);
          if (!/webp/.test(mime))
            return reply(`Reply Sticker With Caption *${prefix + _command}*`);
          reply(mess.wait);
          let { webp2mp4File } = require("./lib/uploader");
          let media = await conn.downloadAndSaveMediaMessage(quoted);
          let webpToMp4 = await webp2mp4File(media);
      ...
      case "ytsearch":
        {
          if (!text)
            return replay(
              `Example : ${prefix + _command} Anime Story Whatsapp`
            );
      ...
      case "google":
        {
          if (!text)
            return reply(`Example : ${prefix + _command} gojo shiba inu`);
      ...
      case "googleimage":
        {
          if (!text) return reply(`Example : ${prefix + _command} gojo`);
            ...
            let buttons = [
              {
                ...
                buttonText: { displayText: "➡️➡️Next Image➡️➡️" },
                type: 1,
              },
            ];
            let buttonMessage = {
              image: { url: images },
              caption: `*-------「 G:IMAGE SEARCH 」-------*
🤠 *Query* : ${text}
🔗 *Media Url* : ${images}`,
              footer: conn.user.name,
              buttons: buttons,
      ...
      case "ytplay":
        {
          if (!text)
            return reply(
              `Example 1 : ${prefix + _command} Stay\nExample 2 : ${
                prefix + "random" + _command
              } Stay`
            );
          let yts = require("yt-search");
          let query = args[0] == "random" ? text.replace("random ", "") : text;
          ...
          let buttons = [
            ...
            },
            {
              ...
              buttonText: { displayText: "📽️Video📽️" },
              type: 1,
            },
            {
              buttonId: `ytplay random ${anu.url}`,
...
🐦 Url : ${anu.url}`,
      ...
      case "getvideoxxx":
        {
          let { ytv } = require("./lib/y2mate");
          if (!text) throw `Example : ${prefix + _command} 1`;
          if (!m.quoted) throw "Reply Message";
          if (!m.quoted.isBaileys)
            throw `Can Only Reply To Meessages From Bots`;
          let urls = quoted.text.match(
            new RegExp(
              /(?:https?:\/\/)?(?:youtu\.be\/|(?:www\.|m\.)?youtube\.com\/(?:watch|v|embed|shorts)(?:\.php)?(?:\?.*v=|\/))([a-zA-Z0-9\_-]+)/,
              "gi"
          ...
          if (!urls)
            throw `Maybe The Message You Replied Does Not Contain The Video Search Result`;
          let quality = args[1] ? args[1] : "360p";
      ...
      case "animexxx":
        {
          ...
          nexusnw
            ...
            .then(async (data) => {
              ...
              await conn.send5ButLoc(from, txt, `© ${ownername}`, gam, but, {
                userJid: m.chat,
                quoted: m,
              });
            })
      ...
      case "blowjob":
        {
          ...
          conn.sendMessage(
            ...
            {
              image: {
                url: api("zenz", "/api/random/" + _command, {}, "apikey"),
              },
              caption: "Generated Random " + _command,
            },
            { quoted: m }
          );
        }
      ...
      case "kopi":
        {
          let buttons = [
            {
              buttonId: `coffe`,
              buttonText: { displayText: "➡️Next Image➡️" },
              type: 1,
            },
          ];
          let buttonMessage = {
          ...
          let buttons = [
            {
              ...
              buttonText: { displayText: "➡️Next➡️" },
              type: 1,
            },
          ];
          let buttonMessage = {
      ...
      case "gluetext":
        {
          if (!text)
            return reply(`Enter Text, Example : ${prefix + _command} Xeon`);
          reply(mess.wait);
          conn.sendMessage(
            m.chat,
            {
      ...
      case "tafsirmimpi":
        {
          if (!text) return reply(`Example : ${prefix + _command} belanja`);
      ...
      case "artinama":
        {
          if (!text) throw `Example : ${prefix + _command} Dika Ardianta`;
      ...
      case "cocoknama":
        {
          if (!text) throw `Example : ${prefix + _command} Dika, 7, 7, 2005`;
      ...
      case "pasangan":
        {
          if (!text) throw `Example : ${prefix + _command} Dika|Novia`;
      ...
      case "jadiannikah":
        {
          if (!text) throw `Example : ${prefix + _command} 6, 12, 2020`;
      ...
      case "sifatusaha":
        {
          if (!ext) throw `Example : ${prefix + _command} 28, 12, 2021`;
          let [tgl, bln, thn] = text.split`,`;
      ...
      case "rezeki":
        {
          if (!text) throw `Example : ${prefix + _command} 7, 7, 2005`;
          let [tgl, bln, thn] = text.split`,`;
      ...
      case "fengshui":
        {
          if (!text)
            throw `Example : ${prefix + _command} Dika, 1, 2005\n\nNote : ${
              prefix + _command
            } Name, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`;
      ...
      case "peruntungan":
        {
          if (!text)
            throw `Example : ${
              ...
              prefix + _command
            } Name, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`;
      ...
      case "memancing":
        {
          if (!text) throw `Example : ${prefix + _command} 12, 1, 2022`;
          let [tgl, bln, thn] = text.split`,`;
          let anu = await primbon.primbon_memancing_ikan(tgl, bln, thn);
          if (anu.status == false) return reply(anu.message);
          conn.sendText(
            m.chat,
            `🐦 *Date :* ${anu.message.tgl_memancing}\n🐦 *Results :* ${anu.message.result}\n🐦 *Notes :* ${anu.message.catatan}`,
            m
          );
        }
        break;
      case "masasubur":
        {
          if (!text)
            throw `Example : ${prefix + _command} 12, 1, 2022, 28\n\nNote : ${
              prefix + _command
            } First Day Of Menstruation Cycle`;
      ...
      case "shio":
        {
          ...
          if (anu.status == false) return reply(anu.message);
          conn.sendText(m.chat, `🐦 *Results :* ${anu.message}`, m);
        }
        break;
      case "stalker":
      case "stalk":
        {
          if (!isPremium && global.db.data.users[m.sender].limit < 1)
            return reply("Your Daily Limit Has Expired");
          if (!text)
            return reply(
              `Example : ${
                prefix + _command
          ...
          if (type.toLowerCase() == "ff") {
            if (!id)
              return reply(
                `No Query id, Example ${prefix + _command} ff 552992060`
              );
            let anu = await fetchJson(
              api("zenz", "/api/nickff", {
            ...
            if (!id)
              return reply(
                `No Query id, Example : ${prefix + _command} ml 214885010 2253`
              );
            if (!zone)
              return reply(
                `No Query id, Example : ${prefix + _command} ml 214885010 2253`
            ...
            if (!id)
              return reply(
                `No Query id, Example ${prefix + _command} aov 293306941441181`
              );
            let anu = await fetchJson(
            ...
            if (!id)
              return reply(
                `No Query id, Example ${prefix + _command} pb riio46`
              );
            let anu = await fetchJson(
              api("zenz", "/api/nickpb", {
                apikey: global.APIKeys[global.APIs["zenz"]],
      ...
      case "tiktokaudiox":
        {
          ...
          reply(mess.wait);
          let anu = await fetchJson(
            api("zenz", "/downloader/musically", { url: text }, "apikey")
          );
          let buttons = [
            {
              buttonId: `tiktoknowm ${text}`,
          ...
          let msg = await conn.sendMessage(m.chat, buttonMessage, {
            quoted: m,
          });
          conn.sendMessage(
            m.chat,
            { audio: { url: anu.result.audio }, mimetype: "audio/mpeg" },
            { quoted: msg }
          );
        }
        break;
          ...
          if (/(?:\/p\/|\/reel\/|\/tv\/)([^\s&]+)/.test(isUrl(text)[0])) {
            ...
            for (let media of anu.data)
              conn.sendMedia(
                ...
                media,
                "",
                `Download Url Instagram From ${isUrl(text)[0]}`,
                m
              );
      ...
      case "igdl2":
        {
          ...
          let anu = await fetchJson(
            api("zenz", "/downloader/instagram2", { url: text }, "apikey")
          );
          conn.sendMessage(
            m.chat,
      ...
      case "jooxdl":
        {
          ...
          reply(mess.wait);
          let anu = await fetchJson(
            api("zenz", "/downloader/joox", { query: text }, "apikey")
          );
          let msg = await conn.sendImage(
            m.chat,
            anu.result.img,
      ...
      case "twitterx":
        {
          ...
          reply(mess.wait);
          let anu = await fetchJson(
            api("zenz", "/api/downloader/twitter", { url: text }, "apikey")
          );
          let buttons = [
            {
      ...
      case "facebookx":
        {
          ...
          reply(mess.wait);
          let anu = await fetchJson(
            api("zenz", "/api/downloader/facebook", { url: text }, "apikey")
          );
          conn.sendMessage(
            m.chat,
            {
      ...
      case "pinterestdl":
        {
          ...
          reply(mess.wait);
          let anu = await fetchJson(
            api("zenz", "/api/downloader/pinterestdl", { url: text }, "apikey")
          );
          conn.sendMessage(
            m.chat,
            { video: { url: anu.result }, caption: `Download From ${text}` },
            { quoted: m }
          );
        }
        break;
...
`,
      ...
      case "ringtone":
        {
          if (!text) return reply(`Example : ${prefix + _command} black rover`);
      ...
      case "juzamma":
        {
          if (args[0] === "pdf") {
            ...
            reply(`What Format Do You Want? ? Example : ${prefix + _command} pdf
...
${prefix + _command} bukhari 1
${prefix + _command} abu-daud 1
...
( Q.S ${res.result.data.surah.name.transliteration.id} : ${res.result.data.number.inSurah} )`;
      ...
      case "squirrel":
        try {
          let set;
          if (/bass/.test(_command))
            set = "-af equalizer=f=54:width_type=o:width=2:g=20";
          if (/blown/.test(_command)) set = "-af acrusher=.1:1:64:0:log";
          if (/deep/.test(_command)) set = "-af atempo=4/4,asetrate=44500*2/3";
          if (/earrape/.test(_command)) set = "-af volume=12";
          if (/fast/.test(_command))
            set = '-filter:a "atempo=1.63,asetrate=44100"';
          if (/fat/.test(_command))
            set = '-filter:a "atempo=1.6,asetrate=22100"';
          if (/nightcore/.test(_command))
            set = "-filter:a atempo=1.06,asetrate=44100*1.25";
          if (/reverse/.test(_command)) set = '-filter_complex "areverse"';
          if (/robot/.test(_command))
            set =
              "-filter_complex \"afftfilt=real='hypot(re,im)*sin(0)':imag='hypot(re,im)*cos(0)':win_size=512:overlap=0.75\"";
          if (/slow/.test(_command))
            set = '-filter:a "atempo=0.7,asetrate=44100"';
          if (/smooth/.test(_command))
            set =
              "-filter:v \"minterpolate='mi_mode=mci:mc_mode=aobmc:vsbmc=1:fps=120'\"";
          if (/tupai/.test(_command))
      ...
      case "lockcmd":
        {
          ...
          global.db.data.sticker[hash].locked = !/^un/i.test(_command);
          reply("Done!");
        }
        break;
      case "addmsg":
        {
          if (!m.quoted)
            return reply(`Reply Message You Want To Save In Database`);
          if (!text) return reply(`Example : ${prefix + _command} File Name`);
          let msgs = global.db.data.database;
          if (text.toLowerCase() in msgs)
            return reply(`'${text}' Has Been Registered In The Message List`);
...
${cpus
  ...
  .join("\n\n")}`
    : ""
      ...
      case "handhold":
        reply(mess.wait);
        axios.get(`https://api.waifu.pics/sfw/${_command}`).then(({ data }) => {
      ...
      case "report":
        {
          if (!text)
            return reply(`Enter The Bug\n\nExample: ${_command} Menu Error`);
          conn.sendMessage(`94761539856@s.whatsapp.net`, {
                    ...
                    rows: [
                      {
                        ...
                        description:
                          "Displays The List Of Anonymous Chat Features",
            ...
            proto.Message.fromObject({
              templateMessage: {
                hydratedTemplate: {
                  hydratedContentText: anu,
                  locationMessage: {
                    jpegThumbnail: fs.readFileSync("./Media/gojo.jpg"),
                  },
...
┗━━「 ${pushname} 」━⭓`,
      ...
      case "tqto":
      case "tqtt":
        ThanksTo(getBuffer, picak, conn, from, unicorn, myweb, sc);
        break;

      case "xn-s":
      case "xn-search":
        {
          if (!text) return reply(`Example: ${prefix + _command} </query>`);
          if (!isCreator) return replay(`${mess.owner}`);
            ...
            request(_url, options, (error, res, body) => {
              ...
              if (!error && res.statusCode == 200) {
                if (body.status == "OK") {
                  ...
                  let buttons = [
                    {
                      buttonId: `xn-video ${body.result[0].url}`,
                      buttonText: { displayText: "First Video📽️" },
                      type: 1,
                    },
                    {
                      buttonId: `xn-video ${body.result[1].url}`,
                      buttonText: { displayText: "Second Video📽️" },
                      type: 1,
                    },
                    {
                      buttonId: `xn-video ${body.result[2].url}`,
                      buttonText: { displayText: "Third Video📽️" },
                      type: 1,
                    },
                  ];
                  let buttonMessage = {
            ...
            request(_url, options, (error, res, body) => {
              ...
              if (!error && res.statusCode == 200) {
                if (body.status == "OK") {
                  ...
                  let buttons = [
                    {
                      buttonId: `xv-video ${body.result[0].url}`,
                      buttonText: { displayText: "First Video📽️" },
                      type: 1,
                    },
                    {
                      buttonId: `xv-video ${body.result[1].url}`,
                      buttonText: { displayText: "Second Video📽️" },
                      type: 1,
                    },
                    {
                      buttonId: `xv-video ${body.result[2].url}`,
                      buttonText: { displayText: "Third Video📽️" },
                      type: 1,
                    },
                  ];
      ...
      case "xn-video":
      case "xn-play":
        if (!text) return reply(`Example: ${prefix + _command} </url>`);
        if (!isCreator) return replay(`${mess.owner}`);
          ...
          request(_url, options, (error, res, reslt) => {
            ...
            if (!error && res.statusCode == 200) {
              if (reslt.status == "OK") {
                let buttons = [
                  {
                    buttonId: `dl-mp4 ${reslt.result.files.high} ${reslt.result.title}`,
                    buttonText: { displayText: "📽️High quality📽️" },
                    type: 1,
                  },
                  {
                    buttonId: `dl-mp4 ${reslt.result.files.Low} ${reslt.result.title}`,
                    buttonText: { displayText: "📽️Low quality📽️" },
                    type: 1,
                  },
                ];
                let buttonMessage = {
      ...
      case "dl-mp4":
        {
          try {
            if (!text)
              return reply(`Example : ${prefix + _command} </Url> </tittle>`);
            ...
            conn.sendMessage(
              m.chat,
              {
                ...
                mimetype: "video/mp4",
                fileName: `${title}.mp4`,
                caption: Bold(`Created By @Dark_Ezio_Whats-Bot`),
              },
              { quoted: m }
            );
          } catch (err) {
